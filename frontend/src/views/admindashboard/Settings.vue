<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
    <div class="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
      ...
      <!-- Profile Header -->
      <div class="bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20 mb-8" data-aos="fade-up">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20" data-aos="fade-right">
        ...
        <!-- Preferences -->
        <div class="bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20" data-aos="fade-up">
          <h2 class="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-3">
        ...
        <!-- Security -->
        <div class="bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20" data-aos="fade-left">
          <h2 class="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-3">
