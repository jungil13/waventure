<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-800">
    <div class="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
      <!-- Header Section -->
      <div class="mb-8">
        <div class="bg-white/10 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20 text-center">
          <h1 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 flex items-center justify-center gap-3">
            <span class="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center">
              <Cog6ToothIcon class="h-8 w-8 text-white" />
            </span>
            Account Settings
          </h1>
          <p class="text-lg text-purple-200">Manage your profile, preferences, and security settings</p>
        </div>
      </div>

      <!-- Profile Header -->
      <div class="bg-white/10 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20 mb-8">
        <div class="flex flex-col md:flex-row items-center gap-6">
          <!-- Profile Picture -->
          <div class="relative">
            <div class="w-32 h-32 rounded-full overflow-hidden border-4 border-purple-300 shadow-lg">
              <img 
            ...
            <button 
              ...
              class="absolute -bottom-2 -right-2 w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-110"
            >
          ...
          <div class="flex-1 text-center md:text-left">
            <h2 class="text-3xl font-bold text-white mb-2">{{ userProfile.full_name || 'User Name' }}</h2>
            <div class="space-y-2">
              <div class="flex items-center justify-center md:justify-start gap-2 text-purple-200">
              ...
              <div class="flex items-center justify-center md:justify-start gap-2 text-purple-200">
                <PhoneIcon class="h-5 w-5 text-purple-400" />
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white/10 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20">
          <h2 class="text-2xl font-bold text-white mb-6 flex items-center gap-3">
            <span class="w-8 h-8 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center">
          ...
          <form @submit.prevent="updateProfile" class="space-y-6">
            <div>
              ...
              <input 
                ...
                class="w-full px-4 py-3 rounded-2xl border-2 border-purple-300 focus:border-purple-500 focus:ring-0 transition-colors bg-white/20 backdrop-blur-sm text-white placeholder-purple-300" 
            ...
            <div>
              <label class="block text-sm font-medium text-purple-200 mb-2">Phone Number</label>
              <input 
                type="tel" 
            ...
            <div>
              <label class="block text-sm font-medium text-purple-200 mb-2">Location</label>
              <input 
                type="text" 
            ...
            <div>
              ...
              <textarea 
                ...
                class="w-full px-4 py-3 rounded-2xl border-2 border-purple-300 focus:border-purple-500 focus:ring-0 transition-colors bg-white/20 backdrop-blur-sm resize-none text-white placeholder-purple-300" 
        ...
        <div class="bg-white/10 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20">
          ...
          <form @submit.prevent="updatePreferences" class="space-y-6">
            <div class="space-y-4">
              <div class="flex items-center justify-between p-4 bg-white/20 rounded-2xl border border-purple-300">
                <div class="flex items-center gap-3">
                  <EnvelopeIcon class="h-6 w-6 text-purple-400" />
                  <div>
                    <p class="font-semibold text-white">Email Notifications</p>
                    <p class="text-sm text-purple-200">Receive updates via email</p>
                  </div>
                </div>
              ...
              <div class="flex items-center justify-between p-4 bg-white/20 rounded-2xl border border-purple-300">
                <div class="flex items-center gap-3">
                  <BellIcon class="h-6 w-6 text-purple-400" />
                  <div>
                    <p class="font-semibold text-white">Push Notifications</p>
                    <p class="text-sm text-purple-200">Receive browser notifications</p>
                  </div>
                </div>
                <label class="relative inline-flex items-center cursor-pointer">
                  <input 
              ...
              <div class="flex items-center justify-between p-4 bg-white/20 rounded-2xl border border-purple-300">
                <div class="flex items-center gap-3">
                  <NewspaperIcon class="h-6 w-6 text-purple-400" />
                  <div>
                    <p class="font-semibold text-white">Newsletter Subscription</p>
                    <p class="text-sm text-purple-200">Receive our newsletter</p>
                  </div>
                </div>
                <label class="relative inline-flex items-center cursor-pointer">
                  <input 
        ...
        <div class="bg-white/10 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20">
          ...
          <form @submit.prevent="changePassword" class="space-y-6">
            <div>
              <label class="block text-sm font-medium text-purple-200 mb-2">Current Password</label>
              <input 
                type="password" 
